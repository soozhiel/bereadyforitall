const SITE_URL = 'https://bereadyforitall.vercel.app';
...
async function sharePage() {
  if (navigator.share) { try { await navigator.share({ title: 'Be Ready For It All — Sonic Remedy | Soozhee', text: 'Be Ready For It All by Soozhee. Sonic Remedy : Audiosensory Resonance | No Regret.', url: SITE_URL }); return; } catch (e) {} }
